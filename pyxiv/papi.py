...
class PixivAPI(BasePixivAPI):
    ...
    def __init__(self, **aiohttp_kwargs):
        ...
        super(PixivAPI, self).__init__(**aiohttp_kwargs)

    # Check auth and set BearerToken to headers
    async def auth_aiohttp_call(self, method, url, headers=None, params=None, data=None):
        if headers is None:
            headers = {}
        self.require_auth()
        ...
        r = await self.aiohttp_call(method, url, headers, params, data)
    ...
    async def bad_words(self):
        ...
        r = await self.auth_aiohttp_call('GET', url)
    ...
    async def works(self, illust_id, include_sanity_level=False):
        ...
        r = await self.auth_aiohttp_call('GET', url, params=params)
        return self.parse_result(r)
    ...
    async def me_favorite_works(self, page=1, per_page=50, publicity='public',
    ...
    async def me_favorite_works_add(self, work_id, publicity='public'):
        ...
        r = await self.auth_aiohttp_call('POST', url, params=params)
        return self.parse_result(r)
    ...
    async def me_favorite_works_delete(self, ids, publicity='public'):
        ...
        r = await self.auth_aiohttp_call('DELETE', url, params=params)
        return self.parse_result(r)
